...
const Farms: React.FC = () => {
  ...
  const [viewMode, setViewMode] = usePersistState(ViewMode.TABLE, { localStorageKey: 'migoswap_farm_view' })
  ...
  const rowData = farmsStakedMemoized.map((farm) => {
    ...
    const lpLabel = farm.lpSymbol && farm.lpSymbol.split(' ')[0].toUpperCase().replace('MigoSwap', '')
  ...
  return (
    <>
      ...
      <Page>
        ...
        {renderContent()}
        <div ref={loadMoreRef} />
        <StyledImage src="/images/briseswap-bg-logo.svg" alt="MigoSwap illustration" width={120} height={103} />
      </Page>
    </>
  )
}
