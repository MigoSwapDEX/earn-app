const config = [
  ...
  },
  {
    ...
    description: [
      'We burn it. The MIGO-CORE LP tokens from the participation fee will be decomposed. We will then use the BNB portion to market buy the MIGO equivalent, and finally throw all of the MIGO into the weekly token burn.',
    ],
  },
  {
    title: 'How can I get an achievement for participating in the IFO?',
    description: [
      'You need to contribute a minimum of about 10 USD worth of MIGO-CORE LP Tokens to either sale.',
