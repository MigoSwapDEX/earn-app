...
export const BASE_URL = 'https://dex.migoswap.org'
export const BASE_EXCHANGE_URL = 'https://dex.migoswap.org'
export const BASE_ADD_LIQUIDITY_URL = `${BASE_EXCHANGE_URL}/#/add`
export const BASE_LIQUIDITY_POOL_URL = `${BASE_EXCHANGE_URL}/#/pool`
export const BASE_BSC_SCAN_URL = 'https://scan.test.btcs.network'
...
export const MAINNET_CHAIN_ID = '1115'
